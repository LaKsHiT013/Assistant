...
def showman(pdf_docs):
    ...
    user_question = st.text_input("Finished Reading. Ask me Anything:", key="user_question")
    ...
    if user_question and not ask_another_question:
        if "docsearch" not in st.session_state:
            st.error("PDFs have not been processed yet. Please upload and process PDFs.")
            st.write("Current session state:", st.session_state)  # Debug info
            return
